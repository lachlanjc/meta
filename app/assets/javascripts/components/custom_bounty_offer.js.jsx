        ...
        <div>
          <div>
            <div style={{ position: 'relative' }}>
              ...
              <input name="earnable" type="text" defaultValue={this.state.value} onChange={this.handleOfferChange} className="field-light yellow bold lg-field" style={{ 'padding-left': '30px' }} />
            </div>
          </div>
          <div className="mt2">
            {this.renderStats()}
